...
Put
\[
b=\frac{\omega_{3-\alpha}(D_{nj})}{\tau_n}\bigl(
...
\[
\omega^\alpha_{nj}\approx bC_1(\delta^+_{nj})^2
    =\frac{1}{\Gamma(3-\alpha)}\,\frac{\tau_j}{\tau_n}\,
    \frac{(\tau_n+\tau_j)^2}{4}\,D_{nj}^{-1-\alpha}.
\]
In the special case of a uniform mesh,
\[
\omega^\alpha_{nj}\approx\frac{\tau}{\Gamma(3-\alpha)}\,D_{nj}^{-1-\alpha}
\]
